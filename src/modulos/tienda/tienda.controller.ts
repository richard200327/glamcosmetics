...
export class TiendaController {
  ...
  @Post('productos/desde-inventario')
  @Roles(Rol.Administrador, Rol.Almacen)
  public publicarDesdeInventario(@Body() datos: PublicarDesdeInventarioDto) {
    return this.productosDeCatalogoService.publicarDesdeInventario(datos);
  }

  @Patch('productos/:id/destacado')
  @Roles(Rol.Administrador, Rol.Almacen)
  public cambiarDestacado(@Param('id', ParseIntPipe) id: number, @Body() datos: CambiarDestacadoDto) {
    return this.productosDeCatalogoService.cambiarDestacado(id, datos.destacado);
  }

  @Patch('productos/:id/visibilidad')
  @Roles(Rol.Administrador, Rol.Almacen)
  public cambiarVisibilidad(@Param('id', ParseIntPipe) id: number, @Body() datos: CambiarVisibilidadDto) {
    return this.productosDeCatalogoService.cambiarVisibilidad(id, datos.visible);
  }
